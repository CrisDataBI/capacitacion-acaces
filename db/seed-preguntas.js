...
const RIESGOS = [
  ...
  { tipo: 'seleccion', enunciado: 'Las sanciones regulatorias de la SSF o INSAFOCOOP por un caso de fraude corresponden al impacto:', opciones: ['Financiero', 'Legal', 'Reputacional'], correcta: 1, explicacion: 'Las sanciones y multas regulatorias se clasifican dentro del impacto legal del fraude.', fuente: 'L3 · Riesgo de Fraude', dificultad: 'intermedio' },
